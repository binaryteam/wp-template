					...
					<div class="captcha_content">
						...
						<div class="clearfix">	
							...
							<div class="clearfix">
								...
								<span class="img_captcha">
								<img id="captcha" class="image_no_margin" alt="<?php bloginfo('name'); ?> Intranet" src="<?php bloginfo( 'template_url' ); ?>/includes/captcha/get_captcha.php" />
								</span>

								<a href="#" id="link_refresh" class="link_refresh">Refresh</a>

								<input placeholder="Escribir código" type="text" id="txt_codigo" name="txt_codigo" class="text float_right required" />

							</div>
						</div>
						
						<?php /* ?><div class="clearfix btn_content">
							<button class="btn_form float_left" type="submit">
								Enviar a JV Resguardo
							</button>
							<button id="btn_clear" class="btn_form btn_clear float_right" type="button">
								Limpiar datos
							</button>
