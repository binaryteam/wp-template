...
var webApp =  (function($){
  ...
  function _updateActiveLink(title){
    jQuery.each($linksAjax, function(index, item){
      if($(item).find('a').html() === title) {
        $nav.find('li').removeClass('active');
